...
exports.searchProducts = async (req, res, next) => {
  ...
  let regexConditions = [
    ...
    { article: { $regex: regexPatterns } },
    { description: { $regex: regexPatterns } },
    { currentPrice: { $regex: regexPatterns } },
    { email: { $regex: regexPatterns } },
    { firstName: { $regex: regexPatterns } },
    { lastName: { $regex: regexPatterns } },
    { telephone: { $regex: regexPatterns } },
    { coordinates: { $regex: regexPatterns } },
    { imageUrls: { $regex: regexPatterns } },
  ];
